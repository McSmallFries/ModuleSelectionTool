...
public class Module implements Comparable<Module>, Serializable {
	...
	private static final long serialVersionUID = -5854343970275019123L;
	...
	public Module() {
		...
		this.delivery = Schedule.YEAR_LONG;
	}
	...
	// private function used to obtain a string output
	// for the delivery enum.
	private String deliveryString()  {
		if (delivery == Schedule.TERM_1)  {
			return "Term 1";
		}
		else if (delivery == Schedule.TERM_2)  {
			return "Term 2";
		}
		else {
			return "Year Long";
	...
	// a function used for the overview pane to populate the module text areas
	public String getModuleTextOutput()  {
		// mandatory boolean converted to yes/no, string format, rather than true/false.
		String yesOrNo = mandatory ? "Yes" : "No";
		return "Module code: " + moduleCode + ", Module name: " + moduleName
			 + "\nCredits: " + moduleCredits + ", Mandatory?: " + yesOrNo + ", Delivery: "
			 + deliveryString();
	}
